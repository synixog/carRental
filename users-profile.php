                  ...
                  <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="" alt="Profile">
                        <div class="pt-2">
                           <label for="input1" class="form-label">Choose a profile picture</label>
                           <input class="form-control" type="file" id="input1" name="dataFile" multiple>
                         </div>
                        </div>
                      </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="dob" type="date" class="form-control" id="dbo">
                      </div>
                    </div>
